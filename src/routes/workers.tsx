...
function WorkersPage() {
  ...
  const [inviteRole, setInviteRole] = useState("พนักงาน");
  ...
  const inviteRoles = ["พนักงาน", "หัวหน้าทีม", "ผู้จัดการ", "ผู้ช่วยสวน", ...state.organizationRoles.map((role) => role.name)];
